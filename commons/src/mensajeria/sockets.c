...
char* getDescription(t_header item) {
	...
	case JOB_TO_MARTA_FILES:
		return "JOB_TO_MARTA_FILES";
	case JOB_TO_MARTA_MAP_OK:
		return "JOB_TO_MARTA_MAP_OK";
	case JOB_TO_MARTA_MAP_ERROR:
		return "JOB_TO_MARTA_MAP_ERROR";
	case JOB_TO_MARTA_REDUCE_OK:
		return "JOB_TO_MARTA_REDUCE_OK";
	case JOB_TO_MARTA_REDUCE_ERROR:
		return "JOB_TO_MARTA_REDUCE_ERROR";
	case JOB_TO_NODO_HANDSHAKE:
		return "JOB_TO_NODO_HANDSHAKE";
	...
	case JOB_TO_NODO_MAP_SCRIPT:
		return "JOB_TO_NODO_MAP_SCRIPT";
	case JOB_TO_NODO_REDUCE_SCRIPT:
		return "JOB_TO_NODO_REDUCE_SCRIPT";
	case JOB_TO_NODO_MAP_PARAMS:
		return "JOB_TO_NODO_MAP_PARAMS";
	case JOB_TO_NODO_REDUCE_PARAMS:
		return "JOB_TO_NODO_REDUCE_PARAMS";
	...
	case MARTA_TO_JOB_FILE_FOUND:
		return "MARTA_TO_JOB_FILE_FOUND";
	case MARTA_TO_JOB_FILE_NOT_FOUND:
		return "MARTA_TO_JOB_FILE_NOT_FOUND";
	case MARTA_TO_JOB_FILE_ERROR:
		return "MARTA_TO_JOB_FILE_ERROR";
	case MARTA_TO_JOB_JOB_FINISHED:
		return "MARTA_TO_JOB_JOB_FINISHED";
	case MARTA_TO_FS_HANDSHAKE:
		return "MARTA_TO_FS_HANDSHAKE";
	case MARTA_TO_FS_BUSCAR_ARCHIVO:
		return "MARTA_TO_FS_BUSCAR_ARCHIVO";
	case MARTA_TO_FS_BUSCAR_BLOQUE_ARCHIVO:
		return "MARTA_TO_FS_BUSCAR_BLOQUE_ARCHIVO";
	...
	case FS_TO_MARTA_BLOQUES_ARCHIVO:
		return "FS_TO_MARTA_BLOQUES_ARCHIVO";
	case FS_TO_MARTA_ESPERAR_ACTIVACION:
		return "FS_TO_MARTA_ESPERAR_ACTIVACION";
