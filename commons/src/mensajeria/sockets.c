...
char* getDescription(int item) {
	...
	case JOB_TO_NODO_HANDSHAKE: return "JOB_TO_NODO_HANDSHAKE";
	...
	case NODO_TO_JOB_MAP_SCRIPT_OK: return "NODO_TO_JOB_MAP_SCRIPT_OK";
	case NODO_TO_JOB_MAP_SCRIPT_KO: return "NODO_TO_JOB_MAP_SCRIPT_KO";
	...
	case NODO_TO_NODO_GET_BLOQUE_OK: return "NODO_TO_NODO_GET_BLOQUE_OK";
	case NODO_TO_NODO_GET_BLOQUE_KO: return "NODO_TO_NODO_GET_BLOQUE_KO";
	...
	case FS_TO_NODO_HANDSHAKE_OK: return "FS_TO_NODO_HANDSHAKE_OK";
	case FS_TO_MARTA_ESPERAR_ACTIVACION: return "FS_TO_MARTA_ESPERAR_ACTIVACION";
