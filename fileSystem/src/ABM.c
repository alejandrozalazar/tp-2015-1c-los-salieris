...
char* create_directorio(char* nombre, int nivel, char* padre, char* ruta){
	...
	directorio->id = generate_unique_id();
...
t_archivo_self* create_archivo(int tamanio, char* nombre) {
	...
	archivo->id = generate_unique_id();
	archivo->ruta = set_directorio(nombre, true);
...
void mover_archivo(char* nombre, char* destino){
	...
	archivo->ruta = set_directorio(destino, true);
}
...
void copiar_archivo_a_mdfs(char* ruta, char** destino) {
...
void copiar_archivo_a_local(char* nombre) {
