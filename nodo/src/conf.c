...
void cargarConfiguracionPorDefecto(conf_nodo* conf) {
	...
	conf->IP_FS = "10.0.2.15"; //	x.y.z.w	IP de la computadora donde está ejecutándose el FileSystem
	...
	conf->IP_NODO = "10.0.2.15"; //	a.b.c.d.	IP de la computadora donde está ejecutándose este proceso nodo. (puede obtenerse del sistema)
